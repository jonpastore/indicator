...
```go
import "github.com/jonpastore/indicator/v2/volatility"
```
...
## type [AccelerationBands](<https://github.com/jonpastore/indicator/blob/master/volatility/acceleration_bands.go#L27-L30>)
...
### func [NewAccelerationBands](<https://github.com/jonpastore/indicator/blob/master/volatility/acceleration_bands.go#L33>)
...
### func \(\*AccelerationBands\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/acceleration_bands.go#L40>)
...
### func \(\*AccelerationBands\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/acceleration_bands.go#L86>)
...
<a name="Atr"></a>
## type [Atr](<https://github.com/jonpastore/indicator/blob/master/volatility/atr.go#L32-L35>)
...
<a name="NewAtr"></a>
### func [NewAtr](<https://github.com/jonpastore/indicator/blob/master/volatility/atr.go#L38>)
...
### func [NewAtrWithMa](<https://github.com/jonpastore/indicator/blob/master/volatility/atr.go#L48>)
...
### func [NewAtrWithPeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/atr.go#L43>)
...
### func \(\*Atr\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/atr.go#L55>)
...
### func \(\*Atr\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/atr.go#L70>)
...
## type [BollingerBandWidth](<https://github.com/jonpastore/indicator/blob/master/volatility/bollinger_band_width.go#L24-L27>)
...
### func [NewBollingerBandWidth](<https://github.com/jonpastore/indicator/blob/master/volatility/bollinger_band_width.go#L30>)
...
### func \(\*BollingerBandWidth\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/bollinger_band_width.go#L37>)
...
### func \(\*BollingerBandWidth\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/bollinger_band_width.go#L47>)
...
## type [BollingerBands](<https://github.com/jonpastore/indicator/blob/master/volatility/bollinger_bands.go#L29-L32>)
...
### func [NewBollingerBands](<https://github.com/jonpastore/indicator/blob/master/volatility/bollinger_bands.go#L35>)
...
### func \(\*BollingerBands\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/bollinger_bands.go#L42>)
...
### func \(\*BollingerBands\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/bollinger_bands.go#L74>)
...
## type [ChandelierExit](<https://github.com/jonpastore/indicator/blob/master/volatility/chandelier_exit.go#L30-L36>)
...
### func [NewChandelierExit](<https://github.com/jonpastore/indicator/blob/master/volatility/chandelier_exit.go#L39>)
...
### func \(\*ChandelierExit\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/chandelier_exit.go#L47>)
...
### func \(\*ChandelierExit\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/chandelier_exit.go#L81>)
...
## type [DonchianChannel](<https://github.com/jonpastore/indicator/blob/master/volatility/donchian_channel.go#L30-L36>)
...
### func [NewDonchianChannel](<https://github.com/jonpastore/indicator/blob/master/volatility/donchian_channel.go#L39>)
...
### func [NewDonchianChannelWithPeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/donchian_channel.go#L44>)
...
### func \(\*DonchianChannel\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/donchian_channel.go#L52>)
...
### func \(\*DonchianChannel\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/donchian_channel.go#L74>)
...
## type [KeltnerChannel](<https://github.com/jonpastore/indicator/blob/master/volatility/keltner_channel.go#L29-L35>)
...
### func [NewKeltnerChannel](<https://github.com/jonpastore/indicator/blob/master/volatility/keltner_channel.go#L38>)
...
### func [NewKeltnerChannelWithPeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/keltner_channel.go#L43>)
...
### func \(\*KeltnerChannel\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/keltner_channel.go#L51>)
...
### func \(\*KeltnerChannel\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/keltner_channel.go#L82>)
...
<a name="MovingStd"></a>
## type [MovingStd](<https://github.com/jonpastore/indicator/blob/master/volatility/moving_std.go#L17-L20>)
...
### func [NewMovingStd](<https://github.com/jonpastore/indicator/blob/master/volatility/moving_std.go#L23>)
...
### func [NewMovingStdWithPeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/moving_std.go#L28>)
...
### func \(\*MovingStd\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/moving_std.go#L35>)
...
### func \(\*MovingStd\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/moving_std.go#L67>)
...
<a name="Po"></a>
## type [Po](<https://github.com/jonpastore/indicator/blob/master/volatility/po.go#L28-L37>)
...
<a name="NewPo"></a>
### func [NewPo](<https://github.com/jonpastore/indicator/blob/master/volatility/po.go#L40>)
...
### func [NewPoWithPeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/po.go#L45>)
...
### func \(\*Po\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/po.go#L54>)
...
### func \(\*Po\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/po.go#L114>)
...
<a name="SuperTrend"></a>
## type [SuperTrend](<https://github.com/jonpastore/indicator/blob/master/volatility/super_trend.go#L39-L42>)
...
### func [NewSuperTrend](<https://github.com/jonpastore/indicator/blob/master/volatility/super_trend.go#L45>)
...
### func [NewSuperTrendWithMa](<https://github.com/jonpastore/indicator/blob/master/volatility/super_trend.go#L64>)
...
### func [NewSuperTrendWithPeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/super_trend.go#L55>)
...
### func \(\*SuperTrend\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/super_trend.go#L72>)
...
### func \(\*SuperTrend\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/super_trend.go#L162>)
...
<a name="UlcerIndex"></a>
## type [UlcerIndex](<https://github.com/jonpastore/indicator/blob/master/volatility/ulcer_index.go#L30-L33>)
...
### func [NewUlcerIndex](<https://github.com/jonpastore/indicator/blob/master/volatility/ulcer_index.go#L36>)
...
### func \(\*UlcerIndex\[T\]\) [Compute](<https://github.com/jonpastore/indicator/blob/master/volatility/ulcer_index.go#L43>)
...
### func \(\*UlcerIndex\[T\]\) [IdlePeriod](<https://github.com/jonpastore/indicator/blob/master/volatility/ulcer_index.go#L78>)
